                    ...
                    <Box>
                        <div className='box_signUp' >
                            <Toaster
                                ...
                                reverseOrder={false}
                            />
                            <StyledFormControl fullWidth variant="outlined" sx={{ borderRadius: 20, position:"relative" }}>
                                    ...
                                    InputProps={{
                                        ...
                                        startAdornment: (
                                            <InputAdornment position="start">
                                                <div style={{width:'43px', height:'43px', marginTop:'12px',marginLeft:'-14px', borderRadius:'50px', backgroundColor:'whitesmoke', display:'flex', justifyContent:'center', alignItems:'center'}}>
                                                    <PersonRoundedIcon style={{ color: '#FF8674' }} />  
                                                </div>    
                                            </InputAdornment>
                                        )
                                    }}            
                                    sx={{ marginTop: 1,marginBottom: 2, outline: 'none', borderRadius: 20, width:'26ch', height:'5ch', color: 'white', backgroundColor:'rgba(255, 255, 255, 0.3)', '&:before':{
                                        content: '""',
                                        position: 'absolute',
                                        top: 0,
                                        left: 0,
                                ...
                                <StyledFormControl fullWidth variant="outlined" sx={{ borderRadius: 20, position:"relative" }}>
                                    ...
                                    <TextField
                                        ...
                                        InputProps={{
                                            ...
                                            startAdornment: (
                                                <InputAdornment position="start" sx={{cursor:'pointer'}}>
                                                    <div onClick={()=>setShowPassword(!showPassword)} style={{width:'43px', height:'43px', marginTop:'12px',marginLeft:'-14px', borderRadius:'50px', backgroundColor:'whitesmoke', display:'flex', justifyContent:'center', alignItems:'center'}}>
                                        ...
                                        sx={{ marginTop: 1,marginBottom: 2, borderRadius: 20, width:'26ch', height:'5ch', color: 'white', backgroundColor:'rgba(255, 255, 255, 0.3)', '&:before':{
                                            content: '""',
                                            position: 'absolute',
                                            top: 0,
                                            left: 0,
                            ...
                            <StyledFormControl fullWidth variant="outlined" sx={{ borderRadius: 20, position:"relative" }}>
                                    ...
                                    <TextField
                                        ...
                                        InputProps={{
                                            ...
                                            startAdornment: (
                                                <InputAdornment position="start" sx={{cursor:'pointer'}}>
                                                    <div onClick={()=>setShowPassword1(!showPassword1)} style={{width:'43px', height:'43px', marginTop:'12px',marginLeft:'-14px', borderRadius:'50px', backgroundColor:'whitesmoke', display:'flex', justifyContent:'center', alignItems:'center'}}>
                            ...
                            <div style={{position:'relative'}}>
                                <Button
                                    variant='contained'
                                    sx={{ marginTop: 1,borderRadius: 20, width: '29ch', height:'5.5ch', fontWeight:'bold', backgroundColor: 'rgba(255,134,116, 0.8)', '&:before':{
                                        content: '""',
                                        position: 'absolute',
                                        top: 0,
                                        left: 0,
                            ...
                            <div style={{display:'flex', width:'268px', justifyContent:'center', alignItems:'center', marginTop:'8px'}}>
                                ...
                                <Button>
                                    <div style={{width:'40px', height:'40px', padding:'6px', marginTop:'5px', border:'1px solid white', borderRadius:'50px'}}>
                                        <Link to='/login' style={{ textDecoration: 'none'}}><LoginRoundedIcon style={{ color: 'white'}} /></Link>
                                    </div>
