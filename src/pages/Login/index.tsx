                    ...
                    <Box>
                        <div className='box_login' >
                            ...
                            <div style={{display:'flex', width:'268px', justifyContent:'center', alignItems:'center', marginTop:'20px'}}>
                                ...
                                <Button>
                                    <div style={{width:'40px', height:'40px', padding:'6px', border:'1px solid white', borderRadius:'50px'}}>
                                        <Link to='/register' style={{ textDecoration: 'none'}}><AppRegistrationRoundedIcon style={{ color: 'white'}} /></Link>
                                    </div>
